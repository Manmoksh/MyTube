...
export const videoselctSchema = createSelectSchema(videos);
...
export const commentSelctSchema = createSelectSchema(comments);
...
export const commentReactionsInsertSchema =
  createInsertSchema(commentReactions);
export const commentReactionsUpdateSchema =
  createUpdateSchema(commentReactions);
export const commentReactionsselctSchema = createSelectSchema(commentReactions);
...
export const videoViewsselctSchema = createSelectSchema(videoViews);
...
export const videoReactionsselctSchema = createSelectSchema(videoReactions);
